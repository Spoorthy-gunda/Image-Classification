...
def build_model():
  ...
  model.add(Conv2D(128,(3,3),padding='same',use_bias=True,kernel_initializer='glorot_uniform',activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
  # model.add(Conv2D(128,(3,3),padding='same',use_bias=True,kernel_initializer='glorot_uniform',activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
  model.add(MaxPooling2D((2,2),strides=(2,2)))
  model.add(BatchNormalization())
  model.add(Dropout(dropout))
  
  model.add(Conv2D(256,(3,3),padding='same',use_bias=True,kernel_initializer='glorot_uniform',activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
  model.add(Conv2D(256,(3,3),padding='same',use_bias=True,kernel_initializer='glorot_uniform',activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
  # model.add(Conv2D(256,(3,3),padding='same',use_bias=True,kernel_initializer='glorot_uniform',activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
  model.add(MaxPooling2D((2,2),strides=(2,2)))
  model.add(BatchNormalization())
  ...
  model.add(Conv2D(512,(3,3),padding='same',use_bias=True,kernel_initializer='glorot_uniform',activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
  model.add(Conv2D(512,(3,3),padding='same',use_bias=True,kernel_initializer='glorot_uniform',activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
  # model.add(Conv2D(512,(3,3),padding='same',use_bias=True,kernel_initializer='glorot_uniform',activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
  model.add(MaxPooling2D((2,2),strides=(2,2)))
  model.add(BatchNormalization())
  ...
  model.add(Flatten())
  model.add(Dense(256,kernel_initializer='glorot_uniform',use_bias=True, activation='relu',kernel_regularizer=keras.regularizers.l2(wd)))
